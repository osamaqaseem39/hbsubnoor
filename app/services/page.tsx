    ...
    <div className="min-h-screen py-12 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <section className="mb-16">
          <p className="text-lg text-text-primary leading-relaxed text-center max-w-4xl mx-auto mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-bg-card border-2 border-border-secondary rounded-lg p-8 hover:shadow-xl transition-shadow">
            <div className="bg-bg-accent text-black w-16 h-16 rounded-full flex items-center justify-center text-2xl mb-6">
              ⚙️
            </div>
            <h2 className="text-2xl font-bold mb-4 text-text-heading">
              Custom Manufacturing
            </h2>
            ...
            <ul className="space-y-2 text-text-primary opacity-90">
        ...
        {/* Service Benefits */}
        <section className="bg-gradient-to-br from-bg-hero to-bg-hero-gradient text-black p-8 md:p-12 rounded-lg mb-16">
        ...
        {/* CTA */}
        <section className="text-center bg-bg-card p-8 rounded-lg">
          <h2 className="text-2xl font-bold mb-4 text-text-heading">
          ...
          <Link 
            href="/contact" 
            className="inline-block bg-bg-accent text-black px-8 py-3 rounded-lg font-semibold hover:bg-bg-accent-hover transition-colors"
          >
            Request a Quote
          </Link>
        </section>
