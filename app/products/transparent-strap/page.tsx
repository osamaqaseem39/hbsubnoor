...
export const metadata: Metadata = {
  title: 'Transparent Packaging Straps | Clear Packaging Straps | HB Sub Noor Industries',
  description: 'Transparent packaging straps for retail-facing goods where package design must remain visible. Sleek, professional, and discreet hold with tamper-evident properties. Quality transparent straps from leading manufacturer. Perfect for retail packaging, cosmetics, and food boxes.',
  keywords: [
    'transparent strap',
    'clear strap',
    ...
    'transparent packaging strap manufacturer',
    'quality transparent straps',
    'premium transparent strap',
    'clear packaging solutions'
  ],
  openGraph: {
    title: 'Transparent Packaging Straps | Clear Packaging Straps | HB Sub Noor Industries',
    description: 'Transparent packaging straps for retail-facing goods. Professional presentation with tamper-evident properties from leading manufacturer.',
  ...
  twitter: {
    ...
    title: 'Transparent Packaging Straps | Clear Packaging Straps',
    description: 'Transparent packaging straps for retail-facing goods. Professional presentation available from leading manufacturer.',
...
export default function TransparentStrapPage() {
  const productStructuredData = {
    ...
    "description": "Transparent packaging straps designed for retail-facing goods or situations where the package design must remain clearly visible. Sleek, professional, and discreet hold from leading manufacturer.",
    "brand": {
      "@type": "Brand",
          ...
          <section className="py-12 px-4 bg-gradient-to-br from-bg-primary via-bg-card/20 to-bg-primary">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
              ...
              <div className="space-y-6">
                ...
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold leading-tight text-text-heading">
                  <span className="block">Invisible Security,</span>
                  <span className="block drop-shadow-2xl">Visible Quality</span>
                </h2>
            ...
            <div className="bg-bg-card p-8 rounded-2xl shadow-xl border border-border-accent/20 mb-12">
              <h3 className="text-2xl font-extrabold leading-tight mb-6 text-text-heading">
                ...
                <span className="block drop-shadow-2xl">Features</span>
              </h3>
