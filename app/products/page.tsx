      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <section className="mb-16">
          <p className="text-lg text-text-secondary leading-relaxed text-center max-w-4xl mx-auto">
            HB Sub Noor Industries provides a complete ecosystem of packaging security, offering customizable strap materials and the machines required for high-speed application.
          </p>
        </section>

        {/* Packaging Straps Section */}
        <section className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-text-heading text-center">
            High-Performance Packaging Straps
          </h2>
          <p className="text-lg text-text-secondary mb-8 leading-relaxed text-center max-w-4xl mx-auto">
            We manufacture a comprehensive range of Polypropylene (PP) and Polyester (PET) plastic poly packaging straps. These polymers are engineered for maximum tensile strength, shock absorption, and reliable elongation recovery, ensuring package integrity during transport.
          </p>

          <div className="grid md:grid-cols-2 gap-8">
            {/* Custom Sized Strap */}
            <div className="bg-bg-card border-2 border-border-secondary rounded-lg p-6 hover:shadow-lg transition-shadow">
              <div className="bg-bg-accent text-text-on-accent w-12 h-12 rounded-full flex items-center justify-center font-bold text-xl mb-4">
                1
              </div>
              ...
              <p className="text-white mb-4 leading-relaxed">
                This solution moves beyond standard dimensions, engineering strap to fit the exact product geometry, which is crucial for specialized goods or irregularly shaped packages.
              </p>
              <div className="mb-4">
                <h4 className="font-semibold text-text-heading mb-2">Application Focus:</h4>
              ...
              <div>
                <h4 className="font-semibold text-text-heading mb-2">Key Business Benefits:</h4>
            ...
            <div className="bg-bg-card border-2 border-border-secondary rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-white mb-4 leading-relaxed">
                Our printed straps turn your packaging into a mobile billboard and an enhanced security feature. We use high-contrast, durable, and fade-resistant ink to ensure longevity and visibility.
              </p>
              <div className="mb-4">
                <h4 className="font-semibold text-text-heading mb-2">Application Focus:</h4>
            ...
            <div className="bg-bg-card border-2 border-border-secondary rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-white mb-4 leading-relaxed">
                More than just aesthetics, colored strap is a powerful tool for warehouse management, tracking, and safety protocols.
              </p>
              <div className="mb-4">
                <h4 className="font-semibold text-text-heading mb-2">Application Focus:</h4>
            ...
            <div className="bg-bg-card border-2 border-border-secondary rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-white mb-4 leading-relaxed">
                This strap is designed for retail-facing goods or situations where the package design must remain clearly visible. It offers a sleek, professional, and discreet hold.
              </p>
              <div className="mb-4">
                <h4 className="font-semibold text-text-heading mb-2">Application Focus:</h4>
          ...
          <div className="mt-12 bg-bg-accent text-text-on-accent p-8 rounded-lg">
            <h3 className="text-2xl font-bold mb-4 text-text-on-accent">
              Customization Options Available
            </h3>
            <div className="grid md:grid-cols-5 gap-4 text-center">
              <div className="bg-bg-card/10 p-4 rounded">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Fully Automatic */}
            <div className="bg-gradient-to-br from-bg-hero to-bg-hero-gradient text-text-on-accent rounded-lg p-8">
              <h3 className="text-2xl font-bold mb-4 text-text-on-accent">
              ...
              <div className="mb-6">
                <h4 className="font-semibold mb-2 text-text-heading">Function:</h4>
              ...
              <div className="mb-6">
                <h4 className="font-semibold mb-2 text-text-heading">Operation:</h4>
                <p className="text-sm leading-relaxed">
              ...
              <div>
                <h4 className="font-semibold mb-2 text-text-heading">Recommendation:</h4>
                <p className="text-sm leading-relaxed">
            ...
            {/* Semi Automatic */}
            <div className="bg-bg-card border-2 border-border-accent rounded-lg p-8">
              <h3 className="text-2xl font-bold mb-4 text-text-heading">
              ...
              <div className="mb-6">
                <h4 className="font-semibold mb-2 text-text-heading">Key Technical Specs:</h4>
                <ul className="text-sm space-y-2 text-text-secondary">
                  ...
                  <li><strong>Strap Width:</strong> Compatible with 9mm, 12mm, and 15.5mm strap</li>
                </ul>
              </div>
              
              <div>
                <h4 className="font-semibold mb-2 text-text-heading">Application Suitability:</h4>
